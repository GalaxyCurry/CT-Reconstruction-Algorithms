...
e = [];
defaults = {'shepp-logan', 'modified shepp-logan', 'modified shepp-logan gray', 'yu-ye-wang'};
...
for i=1:nargin
   if ischar(varargin{i})         % Look for a default phantom
      ...
      case 'modified shepp-logan gray'
         e = modified_shepp_logan_gray;
      case 'yu-ye-wang'
         e = yu_ye_wang;
      end
...
%     -----------------------------------------------------------------
e = [ 2.0  .6900  .920  .900      0       0       0      0      0      0
      -.8  .6624  .874  .880      0       0       0      0      0      0
      -.2  .1100  .310  .220    .22       0       0    -18      0     10
      -.2  .1600  .410  .280   -.22       0       0     18      0     10
       .1  .2100  .250  .410      0     .35       0      0      0      0
       .1  .0460  .046  .050      0      .1       0      0      0      0
       .1  .0460  .046  .050      0     -.1       0      0      0      0
       .1  .0460  .023  .050   -.08    -.65       0      0      0      0
       .1  .0230  .023  .020      0    -.65       0      0      0      0
       .1  .0230  .046  .020    .06    -.65       0      0      0      0 ];

return;



function e = modified_shepp_logan_gray
